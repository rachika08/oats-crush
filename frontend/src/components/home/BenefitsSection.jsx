    ...
    <section className="py-16 sm:py-20 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-8 md:items-center">
        ...
        <div className="md:hidden -mx-4 px-4">
          <div className="flex overflow-x-auto snap-x snap-mandatory gap-4 pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        ...
        <div className="hidden md:grid md:grid-cols-1 md:gap-y-16 md:text-left">
          {benefits.map((benefit, index) => (
            <div key={index} className="flex md:items-start md:flex-row md:gap-4">
