    ...
    <div className="marquee-wrapper bg-brand-orange text-white overflow-hidden whitespace-nowrap">
      ...
      >
        {items.map((item, index) => (
          <span
            key={index}
            className="font-heading text-lg sm:text-xl px-4 sm:px-6 flex items-center gap-20 sm:gap-20 flex-shrink-0"
          >
            {item}
            <span aria-hidden="true" className="text-white/30 font-normal">|</span>
          </span>
        ))}
      </div>
    </div>
