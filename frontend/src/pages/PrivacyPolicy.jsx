    ...
    <>
        ...
        <div className="max-w-5xl mx-auto px-6 py-10 text-gray-800">
            ...
            <p className="mb-8 text-gray-600">
                <strong>Last updated:</strong> 26/05/2026
            </p>
            ...
            <section className="mb-8">
                ...
                <h3 className="text-xl font-medium mt-4 mb-2">
                    2.3 Shopping & Transaction Information
                </h3>
                <ul className="list-disc ml-6">
            ...
            <section className="mb-8">
                ...
                <ul className="list-disc ml-6">
                    <li>
                        Directly from you when you place orders, create an
                        account, or contact us
                    </li>
                    <li>Through cookies and tracking technologies</li>
                    <li>Through payment gateways and shipping partners</li>
                    <li>
                        Through social media integrations and analytics tools
                    </li>
                    <li>
                        Through marketplace platforms and third-party vendors
                    </li>
                </ul>
            </section>
            ...
            <section className="mb-8">
                ...
                <p>
                    ...
                    applications. Oats Crush shall not be responsible for
                    privacy practices, content, policies, or security measures
            ...
            <section className="mb-8">
                ...
                <p>
                    Users may voluntarily post reviews, ratings, comments,
                    testimonials, social media tags, or other public content.
                    Such content may become publicly accessible.
                </p>
            </section>
            ...
            <section className="mb-8">
                ...
                <p>
                    ...
                    against unauthorized access, misuse, loss, disclosure, or
                    alteration.
                </p>
            </section>
            ...
            <section className="mb-8">
                ...
                <p>
                    ...
                    disputes, and enforce agreements and policies.
                </p>
            </section>
            ...
            <section className="mb-8">
                ...
                <p>
                    The Platform and Services are not intended for individuals
            ...
            <section className="mb-8">
                ...
                <p>
                    Users accessing the Platform from outside India acknowledge
                    and agree that their information may be stored, processed,
                    and transferred in India or other jurisdictions where our
            ...
            <section className="mb-8">
                ...
                <p>
                    Oats Crush shall not be liable for unauthorized disclosure
                    due to no fault of the Company, hacking attempts, force
                    majeure events, cyber-attacks, or misuse of information by
            ...
            <section className="mb-8">
                ...
                <p>
                    ...
                    accordance with the laws of India. All disputes shall be
            ...
            <section>
                ...
                <p className="mt-3">
                    Oats Crush <br />
                    Dwarka Sector 14, Near Vagas Mall, New Delhi
                </p>
            </section>
        </div>
        <Footer/>
